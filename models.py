...
def baseline_seq2seq_model(input_dim=8896, hiddenStates = 128, lr=0.01, decay=1e-3, parallel=False):
...
def ptrnet_model(input_dim=8896, timesteps = 5,  hiddenStates = 128, lr=0.01, decay=1e-3, parallel=False):
